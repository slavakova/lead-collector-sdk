...
```text
https://cdn.jsdelivr.net/gh/GITHUB_USER/lead-collector-sdk@v1.4.1/lead-collector.js
```
...
For native form redirects/reloads, version 1.4.1 retains a five-minute,
